...
tuplas por paridade, permitindo que tuplas de tamanhos diferentes sejam armazenadas em 
...
\begin{figure}[h]
	...
	\caption{Índice separado por paridade das tuplas}
...
quando disponível. Assim é esperado uma tupla que combina com o template, ou um aviso de \emph{timeout}, o que ocorrer primeiro. Isso garante que 
...
\begin{figure}[h]
	\center
	\includegraphics[width=.75\textwidth]{img/performance1.png}
...
\begin{figure}[h]
	\center
	\includegraphics[width=.75\textwidth]{img/performance2.png}
	\caption{Variação de recebimento durante a execução do algoritmo QL}
	\label{fig:ql_exec}
\end{figure}
