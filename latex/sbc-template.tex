...
requisição é alocada a uma fila de espera. Desse modo, quando uma operação \emph{write} é realizada, a tupla a ser inserida deve primeiramente ser testada contra cada requisição na fila de espera ... continue
